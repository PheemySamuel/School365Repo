<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Detailed.aspx.cs" Inherits="School365.Admin.Results.MasterMarkSheet" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <p align="center" class="auto-style3">NCE DETAILED 100 LEVEL</p>
            <p class="auto-style4">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            </p>
        </div>
        <div>
            <table style="width: 100%; margin-top: 5px; border-top: 1px solid #aaa; border-bottom: 1px solid #aaa; font-size: x-small;" border="0" cellspacing="0">
                <tr>
                    ...
                    %>
                    <th style="border-bottom: 1px solid #aaa; border-top: 1px solid #aaa; border-left: 1px solid #aaa; border-right: 1px solid #aaa;" class="auto-style1" colspan="4"><%Response.Write(getSubjectDetail == null ? "NA" : getSubjectDetail.SubjectCode + "[" + getSubjectDetail.SubjectValue + getSubjectDetail.SubjectUnit + "]");%></th>
                    <%  }%>
                ...
                <tr>
                    ...
                    <%                
                        ...
                        {                     
                    %>
                    <td style="border-bottom: 1px solid #aaa; border-top: 1px solid #aaa; border-left: 1px solid #aaa; border-right: 1px solid #aaa;" class="auto-style1"><%Response.Write("CA");%></td>
                    <td style="border-bottom: 1px solid #aaa; border-top: 1px solid #aaa; border-left: 1px solid #aaa; border-right: 1px solid #aaa;" class="auto-style1"><%Response.Write("EX");%></td>
                ...
                <tr>
                    <%
                        foreach (int setStudentID in getStudentID)
                        {
                            ...
                            var getFailed = (from d in db.Results where d.StudentID == setStudentID && d.TA <= 55 select d.SubjectID).Count();
                    ...
                    %>
                    <td style="border-bottom: 1px solid #aaa; border-top: 1px solid #aaa; border-left: 1px solid #aaa; border-right: 1px solid #aaa;" class="auto-style1"><%Response.Write(getSubjectDetail == null ? "NA" : getSubjectDetail.CA.ToString()); %></td>
                    <td style="border-bottom: 1px solid #aaa; border-top: 1px solid #aaa; border-left: 1px solid #aaa; border-right: 1px solid #aaa;" class="auto-style1"><%Response.Write(getSubjectDetail == null ? "NA" : getSubjectDetail.EXAM.ToString()); %></td>
                    ...
                    <td style="border-bottom: 1px solid #aaa; border-top: 1px solid #aaa; border-left: 1px solid #aaa; border-right: 1px solid #aaa;" class="auto-style1"><%Response.Write(getSubjectDetail == null ? 0.00 : (School365.Util.GradeValue(getSubjectDetail.TA)) * getSubjectDetail.SubjectValue); %></td>
                    <%}
                    %>
